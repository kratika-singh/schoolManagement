...
move_uploaded_file($tempname, $folder);
    ...
    $sql = "UPDATE `student` SET `name`='$name', `class`='$class', `ph`=$ph, `gender`='$gender', `fname`='$fname', `mname`='$mname', `email`='$email', `address`='$address', `lastname`='$lastname', `dob`='$dob', `path`='$folder' WHERE username='$user'";
    // var_dump($sql);
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="row">
                    <!-- Student photo div -->
                    <div class="col">
                    <img src="<?=$row['path']?>" alt="profile"  style="border: 1px solid #c9c9c9; width: 12.5rem; height: 11.5rem; border-radius: 100%; background: white;  margin: 20px 80px 20px 17px;">
