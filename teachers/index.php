            ...
            <form>
                    ...
                    <div class="col" style="    margin-top: 25px; width: 75%">
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                                ...
                                <input type="text" id="firstName" class="form-control form-control-lg"
                                    style="width:100%; font-size: 16px;" disabled  value="<?=$row['name']?>"/>
                            </div>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="form-outline">
                                ...
                                <input type="text" id="lastName" class="form-control form-control-lg" value="<?=$row['lastname']?>"
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 d-flex align-items-center">
                        ...
                        <div class="form-outline datepicker w-100">
                            ...
                            <input type="text" class="form-control " id="birthdayDate" disabled
                                style="height: 48px; font-size: medium;" value="<?=$row['dob']?>">
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="femaleGender"
                                value="Female" disabled <?php if($gend=='female'){echo 'checked';}?> />
                        </div>

                        <div class="form-check form-check-inline">
                            <label class="form-check-label" for="maleGender">Male</label>
                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="maleGender"
                                value="Male" disabled  <?php if($gend=='male'){echo 'checked';}?>/>
                        </div>

                        <div class="form-check form-check-inline">
                            <label class="form-check-label" for="otherGender">Other</label>
                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="otherGender"
                                value="Others" disabled <?php if($gend=='other'){echo 'checked';}?>/>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="text" id="father_name" class="form-control form-control-lg"
                                style="width:100%; font-size: 16px;" value="<?=$row['fname']?>" disabled />
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="text" id="mother_name" class="form-control form-control-lg" disabled
                                style="font-size: 16px;" value="<?=$row['mname']?>" />
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 pb-2">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="email" id="emailAddress" class="form-control form-control-lg" disabled
                                style="font-size: 16px;" value="<?=$row['email']?>" />
                        </div>
                    ...
                    <div class="col-md-6 mb-4 pb-2">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="tel" id="phoneNumber" class="form-control form-control-lg" disabled
                                style="font-size: 16px;" value="<?=$row['ph']?>" />
                        </div>
                ...
                <div class="row">
                    <div style="margin-bottom:10px">
                        ...
                        <textarea class="form-control" placeholder="" id="address" style="height:100px;" disabled
                            style="font-size: 16px;"><?=$row['address']?></textarea>
                ...
                <div class="mt-4 pt-2">
                    <a href="editDetails.php?username=<?=$row['username']?>"><button class="btn btn-primary" type="button"
